...
exports.default = {
    ...
    performGraphicalMove: function performGraphicalMove(move) {
        ...
        var makeCastlingMove = function makeCastlingMove(move) {
            ...
            var rook = _this6.pieces[rookFrom];
            delete _this6.pieces[rookFrom];
            _this6.pieces[rookTo] = rook;
            _this6.setPiecePosition(rook.object, rookTo);
        };
