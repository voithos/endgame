...
var endgame = {
    ...
    setupGame: function setupGame() {
        ...
        _rtc2.default.init().then(_game2.default.create.bind(_game2.default)).then(_views2.default.showWaitScreen.bind(_views2.default)).then(_rtc2.default.listen.bind(_rtc2.default)).then(self.setupMedia.bind(self)).then(self.performMediaCalls.bind(self)).then(self.displayRemoteMedia.bind(self)).then(self.beginGame.bind(self)).done();
    },
    ...
    connectToGame: function connectToGame(gameId) {
        ...
        _rtc2.default.init().then(_game2.default.join.bind(_game2.default, gameId)).then(_rtc2.default.connect.bind(_rtc2.default)).then(self.setupMedia.bind(self)).then(self.performMediaCalls.bind(self)).then(self.displayRemoteMedia.bind(self)).then(self.beginGame.bind(self)).done();
    },
            ...
            new _promise2.default(function (resolve, reject) {
                _rtc2.default.addDataListener(function (data, conn) {
                    if (data.event === 'mediarequestcomplete') {
                        ...
                        (0, _log2.default)('remote media request complete:', self.remoteHasMedia);
    ...
    performMediaCalls: function performMediaCalls() {
        ...
        return _rtc2.default.performMediaCall(isCaller, self.localHasMedia && _media2.default.localMediaStream);
    },
        ...
        return new _promise2.default(function (resolve, reject) {
            if (self.remoteHasMedia) {
                call.on('stream', function (remoteMediaStream) {
                    ...
                    _scene2.default.addFriendScreen(self.side, video);
                    resolve();
                });
            } else {
                _scene2.default.addFriendScreen(self.side);
                resolve();
            }
        });
    },
...
exports.default = {
    create: function create(hostId) {
        var self = this;
        self.ref = new Firebase(_config2.default.gamesUrl);
        self.gameRef = self.ref.push();
        self.gameRef.set({ hostId: hostId });
        return _promise2.default.resolve(self.gameRef.key());
    },
...
exports.default = {
    ...
    setupDataBus: function setupDataBus(conn) {
        ...
        conn.on('open', function () {
            ...
            _lodash2.default.forEach(self.queuedData, function (data) {
                self.conn.send(data);
            });
        });
    },
...
exports.default = {
    init: function init() {
        ...
        self.renderer.setClearColor(new THREE.Color(_config2.default.colors.clear), 1);
    ...
    setInitialCameraPos: function setInitialCameraPos() {
        var self = this;
        self.camera.position.x = _config2.default.gameOpts.cameraStartPos.x;
        self.camera.position.y = _config2.default.gameOpts.cameraStartPos.y;
        self.camera.position.z = _config2.default.gameOpts.cameraStartPos.z;
        self.camera.lookAt(new THREE.Vector3(0, 0, 0));
    },

    setPlayCameraPos: function setPlayCameraPos(side) {
        var self = this;
        self.camera.position.x = _config2.default.gameOpts.cameraPlayPos.x;
        self.camera.position.y = _config2.default.gameOpts.cameraPlayPos.y;
        self.camera.position.z = (side === 'black' ? -1 : 1) * _config2.default.gameOpts.cameraPlayPos.z;
        self.camera.lookAt(new THREE.Vector3(_config2.default.gameOpts.cameraPlayLookAt.x, _config2.default.gameOpts.cameraPlayLookAt.y, _config2.default.gameOpts.cameraPlayLookAt.z));
    },
                ...
                loader.load('data/' + asset + '.json', function (geometry, materials) {
                    ...
                    if (_lodash2.default.contains(_config2.default.assets, asset)) {
                        ...
                        _lodash2.default.forEach(_config2.default.sides, function (side) {
                            ...
                            meshMaterial.ambient.setHex(_config2.default.colors.pieces[side].ambient);
    ...
    addBoard: function addBoard() {
        ...
        self.board.scale.set(_config2.default.gameOpts.boardScale, _config2.default.gameOpts.boardScale, _config2.default.gameOpts.boardScale);
    ...
    highlightActiveTile: function highlightActiveTile() {
        ...
        if (intersected) {
            ...
            self.colorTile(tile, _config2.default.colors.tiles.active);
        }
    },
    ...
    highlightLegalMoves: function highlightLegalMoves(tile) {
        ...
        self.colorTile(tile, _config2.default.colors.tiles.selected);

        // Get legal moves and highlight them
        self.currentLegalMoves = self.legalCallback.call(self, tile.chessPos);
        _lodash2.default.forEach(self.currentLegalMoves, function (move) {
            var tile = self.tiles[move.to];
            tile.isLegalMove = true;
            self.colorTile(tile, _config2.default.colors.tiles.legal);
        });
    },
    ...
    resetTileHighlights: function resetTileHighlights() {
        ...
        _lodash2.default.forEach(self.tiles, function (tile, pos) {
    ...
    recolorTiles: function recolorTiles() {
        ...
        _lodash2.default.forEach(self.tiles, function (tile, pos) {
            ...
            if (tile.isLegalMove) {
                ...
                self.colorTile(tile, _config2.default.colors.tiles.prevFrom);
            } else if (tile.chessPos === self.prevPosTo) {
                self.colorTile(tile, _config2.default.colors.tiles.prevTo);
            }
        });
    },
...
exports.default = {
    init: function init() {
        var self = this;
        self.ref = new Firebase(_config2.default.usersUrl);
    }
};
