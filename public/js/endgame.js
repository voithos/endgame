...
var endgame = {
    ...
    beginDebugGame: function beginDebugGame() {
        this.side = _routes2.default.getDebugSide() || 'white';
...
exports.default = {
    parts: _utils2.default.queryStringParts(window.location.search),
    ...
    getDebugSide: function getDebugSide() {
...
exports.default = {
    ...
    addSkybox: function addSkybox() {
        ...
        var geometry = new THREE.BoxGeometry(150, 100, 200);
