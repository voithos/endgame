...
THREE.ShaderLib[ 'mirror' ] = {
    ...
    uniforms: { "mirrorOpacity": { type: "f", value: 1.0 },
...
THREE.Mirror = function ( renderer, camera, options ) {
	...
	var mirrorOpacity = options.opacity !== undefined ? options.opacity : 1.0;
	...
	this.material.uniforms.mirrorOpacity.value = mirrorOpacity;
